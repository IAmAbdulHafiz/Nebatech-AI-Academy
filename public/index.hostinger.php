 ...
 * Main Entry Point - Hostinger Version
 * 
 * INSTRUCTIONS:
 * 1. Upload ALL project files to: public_html/
 * 2. Rename this file to index.php
 * 3. Make sure .htaccess protects sensitive files
 */

// Path to the application folder (same as public_html)
$appPath = __DIR__;
...
require_once $appPath . '/src/helpers.php';
...
$allowedOrigins = $isProduction 
    ? ['https://nebatech.com', 'https://www.nebatech.com'] 
...
try {
    ...
    file_put_contents($appPath . '/storage/logs/dispatch.log', date('Y-m-d H:i:s') . " - Exception: " . $e->getMessage() . "\n" . $e->getTraceAsString() . "\n", FILE_APPEND);
