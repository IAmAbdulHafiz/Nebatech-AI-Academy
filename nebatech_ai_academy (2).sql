...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2025 at 08:03 PM
...
CREATE TABLE `courses` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `card_color_from` varchar(50) DEFAULT 'from-blue-500',
  `card_color_to` varchar(50) DEFAULT 'to-blue-600',
  `card_modules` int(11) DEFAULT 10,
  `card_features` text DEFAULT NULL,
  `card_duration` varchar(50) DEFAULT '12 months',
...
INSERT INTO `courses` (`id`, `uuid`, `title`, `slug`, `description`, `category_id`, `related_service_id`, `service_description`, `level`, `duration_hours`, `thumbnail`, `facilitator_id`, `status`, `approval_status`, `availability`, `rejection_reason`, `approved_by`, `approved_at`, `ai_generated`, `created_at`, `updated_at`, `card_color_from`, `card_color_to`, `card_modules`, `card_features`, `card_duration`, `card_icon`, `instructor_name`, `instructor_avatar`, `enrollment_count`, `rating`, `review_count`, `is_new`, `category`, `price`, `facilitator_name`, `is_bundle`) VALUES
(10, '0c2d9e9c-c9ba-11f0-9eb6-f48e38a80c71', 'Frontend Development', 'frontend', 'Build stunning, responsive user interfaces with React, Vue, and Angular', NULL, NULL, NULL, 'beginner', 200, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:51:00', 'from-primary/90', 'to-primary', 15, 'React, Vue, Angular', '13-26 months', 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', 'Dr. Sarah Chen', NULL, 12847, 4.8, 2341, 0, 'Development', 3800.00, 'Sarah Chen', 1),
(11, '0c2fbdff-c9ba-11f0-9eb6-f48e38a80c71', 'Backend Development', 'backend', 'Build powerful server-side applications with PHP, Node.js, and Python', NULL, NULL, NULL, 'intermediate', 250, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:51:00', 'from-green-500', 'to-green-600', 18, 'PHP, Node.js, Python', '13-26 months', 'M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01', 'Prof. Michael Roberts', NULL, 10523, 4.7, 1876, 0, 'Development', 4850.00, 'Michael Roberts', 1),
(12, '0c2fc3bf-c9ba-11f0-9eb6-f48e38a80c71', 'Full Stack Development', 'fullstack', 'Master frontend and backend development technologies', NULL, NULL, NULL, 'intermediate', 350, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-purple-500', 'to-purple-600', 25, 'Frontend & Backend', '13-26 months', 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4', 'Dr. Emily Johnson', NULL, 15234, 4.9, 3102, 1, 'Development', 8300.00, 'Emily Johnson', 1),
(13, '0c2fc99b-c9ba-11f0-9eb6-f48e38a80c71', 'AI & Machine Learning', 'ai', 'Build intelligent applications with Deep Learning and NLP', NULL, NULL, NULL, 'advanced', 400, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-pink-500', 'to-pink-600', 30, 'Deep Learning & NLP', '15-30 months', 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z', 'Dr. Alan Turing', NULL, 18567, 4.9, 3845, 1, 'AI & Machine Learning', 6900.00, 'Alan Turing', 1),
(14, '0c2fcfff-c9ba-11f0-9eb6-f48e38a80c71', 'Data Science', 'data-science', 'Extract insights from data using Python, Statistics, and ML', NULL, NULL, NULL, 'intermediate', 380, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-indigo-500', 'to-indigo-600', 28, 'Python, Statistics, ML', '13-26 months', 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', 'Dr. Grace Hopper', NULL, 14231, 4.8, 2654, 0, 'AI & Machine Learning', 9200.00, 'Grace Hopper', 1),
(15, '0c2fd4c1-c9ba-11f0-9eb6-f48e38a80c71', 'Mobile Development', 'mobile', 'Build native iOS and Android apps with React Native and Flutter', NULL, NULL, NULL, 'intermediate', 280, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-orange-500', 'to-orange-600', 20, 'React Native, Flutter', '4-12 months', 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z', 'John Anderson', NULL, 9876, 4.6, 1543, 0, 'Development', 12500.00, 'John Anderson', 1),
(16, '0c2fd794-c9ba-11f0-9eb6-f48e38a80c71', 'Cloud Computing', 'cloud', 'Deploy and manage applications on AWS, Azure, and GCP', NULL, NULL, NULL, 'advanced', 360, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:51:00', 'from-cyan-500', 'to-cyan-600', 26, 'AWS, Azure, GCP', '12-24 months', 'M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z', 'Maria Garcia', NULL, 11234, 4.7, 2098, 1, 'Cloud & DevOps', 13500.00, 'Maria Garcia', 1),
(17, '0c2fda05-c9ba-11f0-9eb6-f48e38a80c71', 'Cybersecurity', 'cybersecurity', 'Protect systems and data with Ethical Hacking and Defense', NULL, NULL, NULL, 'advanced', 320, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:51:00', 'from-red-500', 'to-red-600', 22, 'Ethical Hacking & Defense', '15-30 months', 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z', 'Robert Wilson', NULL, 8765, 4.8, 1687, 0, 'Security', 15500.00, 'Robert Wilson', 1),
(18, '0c2fdca0-c9ba-11f0-9eb6-f48e38a80c71', 'Database Design & Administration', 'database', 'Master SQL, MySQL, PostgreSQL, and MongoDB', NULL, NULL, NULL, 'intermediate', 150, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:51:00', 'from-indigo-500', 'to-indigo-600', 12, 'Query Optimization', '9-12 months', 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4', 'David Thompson', NULL, 7543, 4.6, 1234, 0, 'Database & Backend', 2520.00, 'David Thompson', 1),
(19, '0c2fdf10-c9ba-11f0-9eb6-f48e38a80c71', 'Microsoft Office Suite', 'microsoft-office', 'Excel, Word, PowerPoint, and Outlook mastery', NULL, NULL, NULL, 'beginner', 100, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-blue-600', 'to-blue-700', 10, 'Excel Formulas', '6-8 months', 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'Linda Martinez', NULL, 15678, 4.5, 2987, 0, 'Office Skills', 2280.00, 'Linda Martinez', 1),
(20, '0c2fe178-c9ba-11f0-9eb6-f48e38a80c71', 'Networking Engineering', 'networking', 'Build and manage network infrastructure with TCP/IP and Routing', NULL, NULL, NULL, 'intermediate', 180, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-cyan-500', 'to-cyan-600', 14, 'TCP/IP & Routing', '10-14 months', 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9', 'James Brown', NULL, 6543, 4.6, 1098, 0, 'Networking', 3190.00, 'James Brown', 1),
(21, '0c2fe3d9-c9ba-11f0-9eb6-f48e38a80c71', 'Computer Hardware', 'hardware', 'Computer assembly, troubleshooting, and repair', NULL, NULL, NULL, 'beginner', 80, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-gray-600', 'to-gray-700', 8, 'PC Building', '5-7 months', 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z', 'Patricia Davis', NULL, 5432, 4.4, 876, 0, 'Hardware', 1560.00, 'Patricia Davis', 1),
(22, '0c2fe735-c9ba-11f0-9eb6-f48e38a80c71', 'Digital Literacy', 'digital-literacy', 'Essential computer and internet skills for beginners', NULL, NULL, NULL, 'beginner', 60, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-teal-500', 'to-teal-600', 6, 'Internet Safety', '4-6 months', 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', 'Jennifer Lee', NULL, 9876, 4.7, 1765, 0, 'Digital Literacy', 1200.00, 'Jennifer Lee', 1),
(23, '0c2fe9f7-c9ba-11f0-9eb6-f48e38a80c71', 'Video Editing & Production', 'video-editing', 'Create professional videos with Adobe Premiere Pro and Motion Graphics', NULL, NULL, NULL, 'intermediate', 120, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-rose-500', 'to-rose-600', 11, 'Premiere Pro', '7-9 months', 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', 'Christopher Taylor', NULL, 8234, 4.7, 1543, 1, 'Media & Design', 1790.00, 'Christopher Taylor', 1),
(24, '0c2fec6c-c9ba-11f0-9eb6-f48e38a80c71', 'Graphic Design & Digital Arts', 'graphic-design', 'Master Photoshop, Illustrator, and Brand Identity', NULL, NULL, NULL, 'intermediate', 150, NULL, NULL, 'published', 'approved', 'both', NULL, NULL, NULL, 0, '2025-11-25 04:48:32', '2025-11-25 06:53:51', 'from-amber-500', 'to-amber-600', 13, 'Adobe Creative Suite', '9-12 months', 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01', 'Amanda White', NULL, 10234, 4.8, 2109, 0, 'Media & Design', 1980.00, 'Amanda White', 1),
(25, 'd4ce1cb3-c9d7-11f0-9eb6-f48e38a80c71', 'HTML & CSS Fundamentals', 'html-css-fundamentals', 'Learn the building blocks of web development with HTML5 and CSS3.', NULL, NULL, NULL, 'beginner', 40, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-orange-500', 'to-orange-600', 8, 'Hands-on projects', '40 hours', 'fas fa-code', 'Nebatech Team', NULL, 3500, 4.7, 2845, 0, 'Development', 590.00, 'Sarah Chen', 0),
(26, 'd4d5a2c3-c9d7-11f0-9eb6-f48e38a80c71', 'JavaScript Essentials', 'javascript-essentials', 'Master JavaScript from basics to advanced concepts and ES6+ features.', NULL, NULL, NULL, 'beginner', 60, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-yellow-500', 'to-yellow-600', 12, 'Interactive coding', '60 hours', 'fab fa-js', 'Nebatech Team', NULL, 5200, 4.8, 4321, 0, 'Development', 950.00, 'Sarah Chen', 0),
(27, 'd4d5a7aa-c9d7-11f0-9eb6-f48e38a80c71', 'React.js Complete Guide', 'react-js-complete-guide', 'Build powerful web applications with React, Hooks, and modern patterns.', NULL, NULL, NULL, 'intermediate', 80, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-cyan-500', 'to-blue-600', 15, 'Real-world projects', '80 hours', 'fab fa-react', 'Nebatech Team', NULL, 4800, 4.9, 3567, 0, 'Development', 1550.00, 'Sarah Chen', 0),
(28, 'd4d6ce60-c9d7-11f0-9eb6-f48e38a80c71', 'Vue.js Mastery', 'vue-js-mastery', 'Learn Vue 3, Composition API, Vuex, and build modern SPAs.', NULL, NULL, NULL, 'intermediate', 70, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-green-500', 'to-green-600', 14, 'Build SPAs', '70 hours', 'fab fa-vuejs', 'Nebatech Team', NULL, 3200, 4.6, 1940, 0, 'Development', 1430.00, 'Sarah Chen', 0),
(29, 'd4d6cffd-c9d7-11f0-9eb6-f48e38a80c71', 'Tailwind CSS Fundamentals', 'tailwind-css-fundamentals', 'Build modern UIs rapidly with utility-first CSS framework.', NULL, NULL, NULL, 'beginner', 35, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-teal-500', 'to-cyan-600', 7, 'Utility-first CSS', '35 hours', 'fas fa-palette', 'Nebatech Team', NULL, 2800, 4.7, 2145, 0, 'Development', 710.00, 'Sarah Chen', 0),
(30, 'd4d6d3ac-c9d7-11f0-9eb6-f48e38a80c71', 'Next.js Full Course', 'next-js-full-course', 'Build production-ready React apps with SSR, SSG, and API routes.', NULL, NULL, NULL, 'advanced', 90, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-gray-800', 'to-black', 18, 'Production-ready apps', '90 hours', 'fas fa-layer-group', 'Nebatech Team', NULL, 2500, 4.9, 1680, 0, 'Development', 1790.00, 'Sarah Chen', 0),
(31, 'd4dcb7d7-c9d7-11f0-9eb6-f48e38a80c71', 'Node.js Fundamentals', 'node-js-fundamentals', 'Build scalable server-side applications with Node.js and Express.', NULL, NULL, NULL, 'beginner', 50, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-green-600', 'to-green-700', 10, 'RESTful APIs', '50 hours', 'fab fa-node-js', 'Nebatech Team', NULL, 4200, 4.7, 3145, 0, 'Development', 890.00, 'Michael Roberts', 0),
(32, 'd4dcd41f-c9d7-11f0-9eb6-f48e38a80c71', 'Python Backend Development', 'python-backend-development', 'Master Python, Django, and Flask for web development.', NULL, NULL, NULL, 'beginner', 60, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-blue-600', 'to-indigo-700', 12, 'Web frameworks', '60 hours', 'fab fa-python', 'Nebatech Team', NULL, 5100, 4.8, 4235, 0, 'Development', 1050.00, 'Michael Roberts', 0),
(33, 'd4dcd57b-c9d7-11f0-9eb6-f48e38a80c71', 'PHP & Laravel Mastery', 'php-laravel-mastery', 'Build robust web applications with PHP and Laravel framework.', NULL, NULL, NULL, 'intermediate', 70, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-purple-600', 'to-pink-600', 14, 'MVC architecture', '70 hours', 'fab fa-php', 'Nebatech Team', NULL, 3800, 4.6, 2987, 0, 'Development', 1180.00, 'Michael Roberts', 0),
(34, 'd4dcd685-c9d7-11f0-9eb6-f48e38a80c71', 'RESTful API Development', 'restful-api-development', 'Design and build scalable REST APIs with best practices.', NULL, NULL, NULL, 'intermediate', 45, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-orange-600', 'to-red-600', 9, 'API design patterns', '45 hours', 'fas fa-server', 'Nebatech Team', NULL, 3500, 4.7, 2654, 0, 'Development', 780.00, 'Michael Roberts', 0),
(35, 'd4dcd761-c9d7-11f0-9eb6-f48e38a80c71', 'GraphQL Complete Guide', 'graphql-complete-guide', 'Master GraphQL for modern API development.', NULL, NULL, NULL, 'advanced', 40, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-pink-600', 'to-purple-700', 8, 'Modern APIs', '40 hours', 'fas fa-project-diagram', 'Nebatech Team', NULL, 2200, 4.8, 1876, 0, 'Development', 950.00, 'Michael Roberts', 0),
(36, 'd4dcd8b5-c9d7-11f0-9eb6-f48e38a80c71', 'Microservices Architecture', 'microservices-architecture', 'Build and deploy microservices with Docker and Kubernetes.', NULL, NULL, NULL, 'advanced', 80, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-indigo-700', 'to-blue-800', 16, 'Cloud-native apps', '80 hours', 'fas fa-cubes', 'Nebatech Team', NULL, 1900, 4.9, 1543, 0, 'Development', 1850.00, 'Michael Roberts', 0),
(37, 'd4e19890-c9d7-11f0-9eb6-f48e38a80c71', 'SQL Mastery', 'sql-mastery', 'Master SQL from basics to advanced queries and optimization.', NULL, NULL, NULL, 'beginner', 45, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-blue-600', 'to-blue-700', 9, 'Query optimization', '45 hours', 'fas fa-database', 'Nebatech Team', NULL, 4500, 4.7, 3421, 0, 'Development', 720.00, 'Emily Davis', 0),
(38, 'd4e3772c-c9d7-11f0-9eb6-f48e38a80c71', 'MySQL Administration', 'mysql-administration', 'Learn MySQL database administration, performance tuning, and security.', NULL, NULL, NULL, 'intermediate', 50, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-orange-600', 'to-orange-700', 10, 'Performance tuning', '50 hours', 'fas fa-cog', 'Nebatech Team', NULL, 2800, 4.6, 2145, 0, 'Development', 850.00, 'Emily Davis', 0),
(39, 'd4e3793b-c9d7-11f0-9eb6-f48e38a80c71', 'MongoDB Complete Guide', 'mongodb-complete-guide', 'Master NoSQL with MongoDB for modern applications.', NULL, NULL, NULL, 'intermediate', 40, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-green-600', 'to-green-700', 8, 'NoSQL design', '40 hours', 'fas fa-leaf', 'Nebatech Team', NULL, 3200, 4.8, 2567, 0, 'Development', 950.00, 'Emily Davis', 0),
(40, 'd4e37a2a-c9d7-11f0-9eb6-f48e38a80c71', 'PostgreSQL Advanced', 'postgresql-advanced', 'Advanced PostgreSQL features and performance optimization.', NULL, NULL, NULL, 'advanced', 35, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:44', '2025-11-25 18:09:41', 'from-blue-700', 'to-indigo-800', 7, 'Advanced features', '35 hours', 'fas fa-elephant', 'Nebatech Team', NULL, 1800, 4.7, 1432, 0, 'Development', 780.00, 'Emily Davis', 0),
(41, 'd4e9efbb-c9d7-11f0-9eb6-f48e38a80c71', 'Computer Basics', 'computer-basics', 'Essential computer skills for beginners.', NULL, NULL, NULL, 'beginner', 20, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:45', '2025-11-25 18:09:41', 'from-blue-500', 'to-blue-600', 4, 'Hands-on practice', '20 hours', 'fas fa-desktop', 'Nebatech Team', NULL, 5200, 4.5, 4123, 0, 'Office Skills', 350.00, 'Jessica Turner', 0),
(42, 'd4ec640d-c9d7-11f0-9eb6-f48e38a80c71', 'Internet & Email Skills', 'internet-email-skills', 'Master web browsing, email, and online safety.', NULL, NULL, NULL, 'beginner', 15, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:45', '2025-11-25 18:09:41', 'from-green-500', 'to-green-600', 3, 'Online safety', '15 hours', 'fas fa-globe', 'Nebatech Team', NULL, 4800, 4.6, 3845, 0, 'Office Skills', 290.00, 'Jessica Turner', 0),
(43, 'd4ec658f-c9d7-11f0-9eb6-f48e38a80c71', 'Digital Communication', 'digital-communication', 'Effective digital communication and collaboration tools.', NULL, NULL, NULL, 'beginner', 18, NULL, NULL, 'published', 'draft', 'both', NULL, NULL, NULL, 0, '2025-11-25 08:21:45', '2025-11-25 18:09:41', 'from-purple-500', 'to-purple-600', 4, 'Collaboration tools', '18 hours', 'fas fa-comments', 'Nebatech Team', NULL, 3900, 4.7, 3124, 0, 'Office Skills', 330.00, 'Jessica Turner', 0);
...
CREATE TABLE `enrollments` (
  ...
  `payment_method` enum('mobile_money','card','bank_transfer') DEFAULT NULL,
