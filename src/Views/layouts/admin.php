...
<body class="bg-gray-50" x-data="{ sidebarOpen: false }">
    ...
    <!-- Admin Sidebar -->
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white transform transition-transform duration-300 lg:translate-x-0"
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="<?= url('/admin/dashboard') ?>" 
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 transition group">
            ...
            <div class="pt-4">
                <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Admissions</p>
            </div>
            ...
            <a href="<?= url('/admin/applications') ?>" 
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 transition group">
                ...
                <span class="ml-auto bg-yellow-500 text-gray-900 text-xs font-bold px-2 py-1 rounded-full">
                    <?= $pendingApplications ?>
                </span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?= url('/admin/cohorts') ?>" 
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 transition group">
                <i class="fas fa-users-class text-lg w-5"></i>
                <span class="ml-3 font-medium">Cohorts</span>
            </a>
            ...
            <a href="<?= url('/admin/facilitators') ?>" 
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 transition group">
                <i class="fas fa-chalkboard-teacher text-lg w-5"></i>
                <span class="ml-3 font-medium">Facilitators</span>
            </a>
            ...
            <a href="<?= url('/admin/programs') ?>" 
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 transition group">
                ...
                <span class="ml-3 font-medium">Programs</span>
            </a>
            ...
            <a href="<?= url('/admin/reports') ?>" 
               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 transition group">
                <i class="fas fa-file-chart-line text-lg w-5"></i>
        ...
        <div class="border-t border-gray-700 p-4">
            ...
            <div x-show="profileOpen" 
                 ...
                 x-transition
                 class="mt-2 py-2 bg-gray-700 rounded-lg">
                <a href="<?= url('/profile') ?>" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600">
                    <i class="fas fa-user mr-2"></i> Profile Settings
                </a>
                <a href="<?= url('/logout') ?>" class="block px-4 py-2 text-sm text-red-400 hover:bg-gray-600">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden xl:flex items-center space-x-4 text-sm">
                        ...
                        <div class="flex items-center text-gray-600">
                            ...
                            <span class="font-medium"><?= $totalCourses ?? 0 ?></span>
                            <span class="ml-1 text-gray-500">Courses</span>
                        </div>
                    </div>
        ...
        <footer class="bg-white border-t border-gray-200 py-6 px-6">
            <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0">
                    ...
                    <a href="<?= url('/admin/support') ?>" class="hover:text-gray-900">Support</a>
                </div>
            </div>
        </footer>
    </div>
