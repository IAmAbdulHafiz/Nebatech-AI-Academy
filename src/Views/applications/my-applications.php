                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center mb-3">
                                <?php if (!empty($app['thumbnail'])): ?>
                                    <img src="<?= url('/public/assets/images/' . $app['thumbnail']) ?>" 
                                         alt="<?= htmlspecialchars($app['program_name'] ?? $app['course_title'] ?? 'Program') ?>"
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">
                                        <?= htmlspecialchars($app['program_name'] ?? $app['course_title'] ?? 'Program Application') ?>
                                    </h3>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-900">
                                        ...
                                        <?= !empty($app['submitted_at']) ? date('M j, Y', strtotime($app['submitted_at'])) : (!empty($app['created_at']) ? date('M j, Y', strtotime($app['created_at'])) : 'N/A') ?>
                                    </p>
                                </div>
                        ...
                        <div class="ml-6 text-right">
                            ...
                            <?php if (!empty($app['priority']) && $app['priority'] !== 'normal'): ?>
                    ...
                    <?php if ($app['status'] === 'approved' && !empty($app['cohort_name'])): ?>
