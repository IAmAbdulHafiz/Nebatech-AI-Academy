...
use Nebatech\Models\Categories\CourseCategory;
...
class ProgrammeController extends Controller
{
    ...
    public function category($category)
    {
        ...
        $courses = Course::getByCategory($category);
        
        // Get category info for display
        $categoryInfo = CourseCategory::findBySlug($category);
        $categoryName = $categoryInfo ? $categoryInfo['name'] : ucfirst(str_replace('-', ' ', $category));
        
        // Get all categories for navigation
        $allCategories = CourseCategory::getActive();
